...
import com.Stan.Vision.service.util.FastDFSUtil;
import com.Stan.Vision.service.util.ImageUtil;
import com.Stan.Vision.dao.VideoDao;
import com.Stan.Vision.domain.*;
import com.Stan.Vision.domain.exception.ConditionException;
import com.Stan.Vision.service.util.IpUtil;
...
public class VideoService {
    ...
    public List<VideoBinaryPicture> convertVideoToImage(Long videoId, String fileMd5) throws Exception{
        com.Stan.Vision.domain.File file = fileService.getFileByMd5(fileMd5);
